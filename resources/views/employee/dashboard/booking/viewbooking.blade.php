...
<a href="/employee/dashboard/viewbooking/export">Download Excel</a>
<table class="table">
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          <form action="/employee/dashboard/viewbooking/{{ $Bookinglist->b_id }}" method="post">
                              @csrf
 ...
 <td>{{ $Bookinglist->tour_username }}</td>
    ...
    <td>  
      <form action="/employee/dashboard/delete/{{ $Bookinglist->b_id }}" method="post">
          @csrf
