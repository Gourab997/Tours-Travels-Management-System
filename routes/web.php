...
use App\Http\Controllers\customer\TravelController;
use App\Http\Controllers\customer\BookedTripController;
...
Route::group(['prefix'=>'/guide','middleware'=>['sess','guide']],function(){
    ...
    //tourguide ->profile
    Route::get("/dashboard/profile", [guideController::class, 'profile'])->name('guide.profile');
    Route::get("/dashboard/editprofile/{id}", [guideController::class, 'edit'])->name('guide.edit');
    Route::post("/dashboard/editprofile/{id}", [guideController::class, 'update'])->name('guide.update');
...
Route::get('/booked', [BookedTripController::class, 'index'])->name('booked.index');

//Customer ->Comment

//Route::get('/comment', 'CommentController@comment')->name('myComments');
Route::get("/customer/comment", [CommentController::class, 'index'])->name('myComments');
...
Route::post("comment/destroy/{id}", [CommentController::class, 'destroy'])->name('comment.destroy');
   ...
   Route::get('/dashboard', [UCustomerController::class, 'userdashboard'])->name('user');
    //customer ->profile
    Route::get("/dashboard/profile", [UCustomerController::class, 'profile'])->name('customer.profile');
    Route::get("/dashboard/editprofile/{id}", [UCustomerController::class, 'edit'])->name('customer.edit');
    Route::post("/dashboard/editprofile/{id}", [UCustomerController::class, 'update'])->name('customer.update');

    Route::get('/dashboard/comments', 'customer\CommentController@index')->name('myComments');

    //customer payment

    Route::get('/trip/payment/form/{id}', [TripController::class, 'paymentform'])->name('trip.Payment.form');
    Route::post('/trip/payment', [TripController::class, 'payment'])->name('payment.post');


//customer ->User List
Route::get("/dashboard/Userlist", [UCustomerController::class, 'ulist']);
