...
class AdCustomerController extends Controller
{
    ...
    public function create(Request $req)
    {
        ...
        return view('admin.dashboard.customer.adduser');
    }
    ...
    public function show(Request $req)
    {
        ...
        return view('admin.dashboard.customer.viewuser')->with('customerlist',$customerlist);
    }
    ...
    {
        $customer = Customer::find($id);
        return view('admin.dashboard.customer.edituser')->with('customer',$customer);
    }
