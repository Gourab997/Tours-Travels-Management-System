...
class CommentController extends Controller
{
    public function index()
    {
        ...
        $comments = BlogComment::where('user_id', '=', session('LoggedUser'))->get();
        return view('customer.dashboard.comments.index', compact('comments', 'data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('customer.dashboard.comments.edit', compact('comment'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->update();
        return redirect()->route('myComments')->with('success', 'Comment updated successfull');
    }
    ...
    public function destroy($id)
    {
        $comment = BlogComment::find($id);
        $comment->delete();
        return redirect()->route('myComments')->with('success', 'Comment deleted successfully');
    }
}
